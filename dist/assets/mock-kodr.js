...
define('mock-kodr/components/ember-chart', ['exports', 'ember-cli-chart/components/ember-chart'], function (exports, _emberCliChartComponentsEmberChart) {
...
define('mock-kodr/helpers/moment-duration', ['exports', 'ember-moment/helpers/moment-duration'], function (exports, _emberMomentHelpersMomentDuration) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('mock-kodr/helpers/now', ['exports', 'ember-moment/helpers/now'], function (exports, _emberMomentHelpersNow) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('mock-kodr/models/user-arena', ['exports', 'ember-data', 'ember'], function (exports, _emberData, _ember) {
  ...
  exports['default'] = _emberData['default'].Model.extend({
    ...
    styleProgress: _ember['default'].computed('progress', function () {
      ...
      return _ember['default'].String.htmlSafe("width: " + prog + "%");
...
define('mock-kodr/models/user-concept', ['exports', 'ember-data', 'ember'], function (exports, _emberData, _ember) {
  ...
  exports['default'] = _emberData['default'].Model.extend({
    ...
    // 	return Math.round(prog)
    // }).property('progress'),
    user: _emberData['default'].belongsTo('user', { inverse: 'userConcepts', async: true }),
    concept: _emberData['default'].belongsTo('concept', { inverse: 'userConcepts', async: true })
  });
});
define('mock-kodr/models/user', ['exports', 'ember-data'], function (exports, _emberData) {
  ...
  exports['default'] = _emberData['default'].Model.extend({
    ...
    userConcepts: hasMany('userConcept', { async: true, inverse: 'user' }),
...
define('mock-kodr/routes/charts', ['exports', 'ember'], function (exports, _ember) {
...
define('mock-kodr/routes/user-arenas', ['exports', 'ember', 'ember-simple-auth/mixins/authenticated-route-mixin', 'ember-local-storage'], function (exports, _ember, _emberSimpleAuthMixinsAuthenticatedRouteMixin, _emberLocalStorage) {
	exports['default'] = _ember['default'].Route.extend(_emberSimpleAuthMixinsAuthenticatedRouteMixin['default'], {
		current_user: (0, _emberLocalStorage.storageFor)('current_user'),
		model: function model() {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child2 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("i");
          dom.setAttribute(el1, "class", "fa fa-bar-chart-o");
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode(" Charts & Statistics\n");
          dom.appendChild(el0, el1);
          return el0;
        },
        buildRenderNodes: function buildRenderNodes() {
    ...
    var child3 = (function () {
      return {
        ...
        statements: [["content", "current_user.username", ["loc", [null, [44, 54], [44, 79]]]], ["element", "action", ["invalidateSession"], [], ["loc", [null, [47, 22], [47, 52]]]]],
        locals: [],
        templates: []
      };
    })();
    ...
    return {
      ...
      statements: [["block", "link-to", ["userArenas"], [], 0, null, ["loc", [null, [19, 8], [21, 20]]]], ["block", "if", [["get", "current_user.atLeastTeacher", ["loc", [null, [23, 12], [23, 39]]]]], [], 1, null, ["loc", [null, [23, 6], [34, 13]]]], ["block", "link-to", ["charts"], [], 2, null, ["loc", [null, [36, 8], [38, 20]]]], ["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [42, 12], [42, 35]]]]], [], 3, 4, ["loc", [null, [42, 6], [56, 13]]]], ["content", "outlet", ["loc", [null, [63, 3], [63, 13]]]], ["inline", "login-page", [], ["store", ["subexpr", "@mut", [["get", "store", ["loc", [null, [64, 23], [64, 28]]]]], [], []]], ["loc", [null, [64, 4], [64, 30]]]]],
      locals: [],
...
define("mock-kodr/templates/charts", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        var child0 = (function () {
        ...
        var child2 = (function () {
          return {
            ...
            buildFragment: function buildFragment(dom) {
              ...
              var el1 = dom.createElement("a");
              dom.setAttribute(el1, "href", "");
              dom.setAttribute(el1, "class", "btn btn-warning btn-block");
              var el2 = dom.createElement("i");
              dom.setAttribute(el2, "class", "fa fa-exclamation-triangle");
              dom.appendChild(el1, el2);
              var el2 = dom.createTextNode(" Practice ");
              dom.appendChild(el1, el2);
              var el2 = dom.createComment("");
              dom.appendChild(el1, el2);
              dom.appendChild(el0, el1);
        ...
        var child3 = (function () {
          return {
            ...
            buildFragment: function buildFragment(dom) {
              ...
              var el1 = dom.createElement("a");
              dom.setAttribute(el1, "href", "");
              dom.setAttribute(el1, "class", "btn btn-primary btn-block");
              var el2 = dom.createTextNode("Practice ");
              dom.appendChild(el1, el2);
              var el2 = dom.createComment("");
              dom.appendChild(el1, el2);
      ...
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode(" Concepts that haven't been practiced in a long time are labeled ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("i");
          dom.setAttribute(el2, "class", "fa fa-exclamation-triangle");
          dom.appendChild(el1, el2);
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["element", "action", ["edit"], [], ["loc", [null, [15, 63], [15, 80]]]]],
        locals: [],
        templates: []
      };
    })();
    ...
    return {
      ...
      statements: [["block", "link-to", ["challenge.edit", ["get", "challenge.id", ["loc", [null, [15, 41], [15, 53]]]]], [], 0, null, ["loc", [null, [15, 13], [17, 22]]]], ["content", "challenge.name", ["loc", [null, [22, 7], [22, 25]]]], ["content", "challenge.exp", ["loc", [null, [29, 54], [29, 71]]]], ["block", "if", [["get", "challenge.concepts", ["loc", [null, [30, 16], [30, 34]]]]], [], 1, 2, ["loc", [null, [30, 10], [42, 14]]]], ["content", "yield", ["loc", [null, [54, 0], [54, 9]]]]],
      locals: [],
      templates: [child0, child1, child2]
    };
  })());
    ...
    var child1 = (function () {
      var child0 = (function () {
        var child0 = (function () {
          return {
            ...
            statements: [["content", "concept.name", ["loc", [null, [10, 105], [10, 121]]]]],
            locals: ["concept"],
            templates: []
          };
        })();
        return {
          ...
          statements: [["block", "each", [["get", "concepts", ["loc", [null, [9, 13], [9, 21]]]]], [], 0, null, ["loc", [null, [9, 5], [11, 20]]]]],
          locals: [],
          templates: [child0]
        };
      })();
      ...
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("code");
          var el4 = dom.createTextNode("Rewards: ");
          dom.appendChild(el3, el4);
          var el4 = dom.createComment("");
          dom.appendChild(el3, el4);
...
define("mock-kodr/templates/components/user-arena-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "link-to", ["userArena", ["get", "userArena.id", ["loc", [null, [11, 26], [11, 38]]]]], ["class", "btn btn-primary btn-sm"], 0, null, ["loc", [null, [11, 3], [13, 15]]]], ["content", "userArena.arena.name", ["loc", [null, [22, 7], [22, 31]]]], ["content", "userArena.arena.description", ["loc", [null, [24, 33], [24, 64]]]], ["attribute", "style", ["get", "userArena.styleProgress", ["loc", [null, [28, 49], [28, 72]]]]], ["content", "userArena.progress", ["loc", [null, [29, 5], [29, 27]]]], ["content", "yield", ["loc", [null, [33, 0], [33, 9]]]]],
      locals: [],
      templates: [child0]
    };
  })());
